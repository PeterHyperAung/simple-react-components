...
const Button = ({children, primary, secondary, success, warning, danger, outline, rounded,  ...rest}) => {
  ...
  let finalClassName  = classNames(rest.className + ' flex items-center gap-2.5 px-3 py-1.5 border', {
  ...
  if(outline) finalClassName = finalClassName.replace('text-white', '')
...
Button.propTypes = {
  checkVariationiValue: ({primary, secondary, success, warning, danger}) => {
